  ...
  return (
    <div className="flex h-full flex-col justify-between">
      ...
      <div className="mt-6 flex gap-3 border-t border-gray-100 pt-4">
        ...
        <button className="flex items-center justify-center gap-2 rounded-lg border border-gray-200 px-3 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50 hover:text-primary-500 lg:flex-1">
